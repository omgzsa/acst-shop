...
<template>
  <div class="grid border shadow-sm lg:p-6 xl:p-8 gap-y-4 sm:grid-cols-2">
    ...
    <p class="pt-4 ml-auto text-base sm:col-start-2 col-span-full">
      Teljes összeg:
      <span class="font-medium underline underline-offset-8">{{ total }}</span>
      Ft
    </p>
  </div>
</template>
